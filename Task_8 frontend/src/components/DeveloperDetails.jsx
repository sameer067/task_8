...
let DeveloperDetails = () => {
  ...
  const fetchDeveloper = async () => {
    const { data } = await axios.get(
      `https://dev-room-pg.onrender.com/api/profiles/${developerId}`,
      {
        headers: {
                ...
                <div className="container bg-success text-white text-center p-3">
                  <div className="row">
                    <div className="col">
                      ...
                      <p className="h6">{`Followers: ${
                        selectedProfile.user.followers?.length || 0
                      }`}</p>
                      <p className="h6">{`Followings:${
                        selectedProfile.user.followings?.length || 0
                      }`}</p>
