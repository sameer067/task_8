...
let PostList = (props) => {
  ...
  const getPosts = async () => {
    let { data } = await axios.get("https://dev-room-pg.onrender.com/api/posts/", {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
    ...
    setPosts(data.posts);
    console.log("posts are", data.posts);
    setLoading(false);
  };
  ...
  let submitCreatePost = async (e) => {
    ...
    if (localPost.text.trim() !== "") {
      const { data } = await axios.post(
        "https://dev-room-pg.onrender.com/api/posts/",
        localPost,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  let clickDeletePost = async (postId) => {
    const { data } = await axios.delete(
      `https://dev-room-pg.onrender.com/api/posts/${postId}`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("devroom")}`,
  ...
  let clickLikePost = async (postId) => {
    const { data } = await axios.put(
      `https://dev-room-pg.onrender.com/api/posts/like/${postId}`,
      {},
      {
        headers: {
          "Content-Type": "application/json",
  ...
  const postList = props.follow
    ? posts.filter((post) => post.user.followers?.includes(user._id))
    : posts;
